package Koha::Plugin::Fi::KohaSuomi::RestrictPatronModification;
...
our $metadata = {
    ...
    author          => 'Lari Strand',
    date_authored   => '2024-08-26',
    date_updated    => '2024-08-26',
    minimum_version => '23.11',
    maximum_version => '',
    version         => $VERSION,
    description     => "Rajaa tiettyjen asiakastyyppien muokkaamisen vain superlibrarian-oikeudelle. Määritettävissä.",
};
